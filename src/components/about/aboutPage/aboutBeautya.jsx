    ...
    <div className="w-full">
      ...
      <div className="relative w-full">
        <img
          src="./about/AboutHeader.png"
          alt="Beautya Spa Interior"
          className="object-cover brightness-95 w-full h-auto min-h-[400px] max-h-[600px]"
        />
        <div className="absolute inset-0 bg-black/30">
          <div className="container mx-auto h-full flex flex-col justify-center items-center text-center px-4 py-16">
            <h1 className="text-4xl md:text-6xl text-white font-light mb-6">About Beautya</h1>
            <p className="text-lg md:text-xl text-white/90 max-w-2xl font-light">
              Your journey to perfect skin begins here
            </p>
          ...
          <div className="max-w-4xl mx-auto space-y-12">
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div className="relative w-full">
                <img
                  src="./about/AboutBody.jpg"
                  alt="Beautya Mission"
                  className="object-cover rounded-lg w-full h-auto aspect-[4/3]"
                />
              </div>
              <div className="space-y-6">
                <div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mt-16">
              {[
                ...
                <div
                  key={index}
                  className="text-center space-y-3 p-6 bg-gray-50 rounded-lg transition-all duration-300 ease-in-out hover:-translate-y-2 hover:shadow-lg h-auto"
                >
                  <h4 className="text-xl font-medium text-gray-800">{feature.title}</h4>
                  <p className="text-gray-600">{feature.description}</p>
                </div>
