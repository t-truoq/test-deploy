...
//           "https://e1a2-2405-4802-8132-b860-c0f1-9db4-3f51-d919.ngrok-free.app/api/quiz/recommended-services",
//           {
//             headers: {
...
//       try {
//         const response = await axios.get(
//           "https://e1a2-2405-4802-8132-b860-c0f1-9db4-3f51-d919.ngrok-free.app/api/services",
//           {
//             headers: {
//               "ngrok-skip-browser-warning": "true",
//             },
  ...
  useEffect(() => {
    ...
    const fetchRecommendedServices = async () => {
      try {
        ...
        const response = await axios.get(
          "https://c12e-2405-4802-8132-b860-c0f1-9db4-3f51-d919.ngrok-free.app/api/quiz/recommended-services",
          {
            headers: {
              Authorization: `Bearer ${token}`,
              "ngrok-skip-browser-warning": "true",
    ...
    const fetchAllServices = async () => {
      try {
        const response = await axios.get(
          "https://c12e-2405-4802-8132-b860-c0f1-9db4-3f51-d919.ngrok-free.app/api/services",
          {
            headers: {
              "ngrok-skip-browser-warning": "true",
            },
