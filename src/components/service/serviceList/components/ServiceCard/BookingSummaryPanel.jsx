...
//         {isVisible && (
//           <motion.div
//             className="sticky z-50" // Removed top-0 from className, will handle with inline style
//             id="booking-summary-panel"
//             style={{ top: "10px", marginLeft: "20px" }} // Adjusted top to 70px (match header height) and added margin-left to avoid overlap with service cards
