...
//   // Tự động xóa dịch vụ khi đăng xuất
//   useEffect(() => {
...
//   // Hàm xử lý booking với kiểm tra đăng nhập
//   const handleBookClick = () => {
//     if (!isLoggedIn) {
//       alert("You need to log in to book services. Please log in first."); // Hoặc hiển thị modal
//       return;
//     }
//     onBookServices(); // Chỉ gọi nếu đã đăng nhập
//   };
...
//             disabled={!isLoggedIn} // Thêm disabled để ngăn người dùng nhấn khi chưa đăng nhập
//           >
