...
//         // Enhance booking data with services array including durations
...
//                 id: index + 1,
//                 name,
//                 duration: serviceDurationMap[name] || 0, // Fallback to 0 if not in map
//                 price: data.totalPrice / (data.serviceNames.length || 1) || 0, // Distribute total price evenly
//               }))
//             : [],
//         };
...
//         setBooking({ ...enhancedBooking, totalDuration });
//       } catch (error) {
...
//         // Gọi callback để thông báo cập nhật trạng thái
//         if (onStatusUpdate) {
//           onStatusUpdate(bookingId, newStatus.toUpperCase());
//         }
//       }
//     } catch (error) {
...
//   onStatusUpdate: PropTypes.func, // Thêm prop để callback
// };

// BookingDetails.defaultProps = {
//   onStatusUpdate: () => {}, // Giá trị mặc định
// };
