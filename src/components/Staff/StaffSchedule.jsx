    ...
    const fetchData = async () => {
      try {
        const [schedulesResponse, servicesResponse] = await Promise.all([
          axios.get(
            `https://b5a8-2405-4802-811e-11a0-602d-4a96-8004-ab8a.ngrok-free.app/api/schedules/busy`,
            {
  ...
  const handleCreateBooking = async () => {
    ...
    try {
      const response = await axios.post(
        `https://b5a8-2405-4802-811e-11a0-602d-4a96-8004-ab8a.ngrok-free.app/api/bookings/guest`,
        bookingRequest,
        { headers: { "ngrok-skip-browser-warning": "true" } }
      );
