...
//           "https://1e2e-2405-4802-8132-b860-7837-749b-a544-2447.ngrok-free.app/api/quiz/questions-with-answers",
//           {
//             headers: {
...
//         "https://1e2e-2405-4802-8132-b860-7837-749b-a544-2447.ngrok-free.app/api/quiz/submit",
//         submissionData,
//         {
//           headers: {
//             Authorization: `Bearer ${token}`,
...
//               <div className="mb-8">
//                 <h4 className="text-xl font-semibold text-gray-900 mb-4">Recommended Services</h4>
//                 {quizResult.recommendedServices && quizResult.recommendedServices.length > 0 ? (
//                   <div className="space-y-4">
//                     {quizResult.recommendedServices.map((service) => (
//                       <div key={service.serviceId} className="bg-white border border-gray-200 rounded-lg p-4 shadow-sm">
//                         <h5 className="text-lg font-semibold text-[#A10550] mb-1">{service.name}</h5>
//                         <p className="text-gray-700 mb-2">{service.description}</p>
//                         <div className="flex flex-wrap gap-2 text-sm">
//                           <span className="px-3 py-1 bg-pink-100 text-[#A10550] rounded-full">
//                             ${service.price.toFixed(2)}
//                           </span>
//                           <span className="px-3 py-1 bg-gray-100 text-gray-700 rounded-full">
//                             {service.duration} minutes
//                           </span>
//                           <span className="px-3 py-1 bg-pink-50 text-[#A10550] rounded-full">
//                             For: {service.recommendedSkinTypes.join(", ")}
//                           </span>
//                         </div>
//                       </div>
//                     ))}
//                   </div>
//                 ) : (
//                   <p className="text-center text-gray-600">No recommended services available.</p>
//                 )}
//               </div>
