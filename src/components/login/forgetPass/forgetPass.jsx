...
//         `https://b64a-118-69-182-149.ngrok-free.app/forgotPassword/verifyMail/${email}`,
...
//     try {
//       const response = await axios.post(
//         `https://b64a-118-69-182-149.ngrok-free.app/forgotPassword/verifyOtp/${otp}/${email}`,
//         {},
//         {
//           headers: {
//             "ngrok-skip-browser-warning": "true",
...
//     try {
//       const response = await axios.post(
//         `https://b64a-118-69-182-149.ngrok-free.app/forgotPassword/changePassword/${email}`,
//         {
...
//                 >
//                   <span className="absolute left-0 inset-y-0 flex items-center pl-3">
//                     <Lock className="h-5 w-5 text-[#FF8F5B] group-hover:text-[#FF6B2B]" aria-hidden="true" />
//                   </span>
//                   Change Password
//                 </button>
//               </div>
...
export default function ForgetPassword() {
  ...
  const handleChangePassword = async (e) => {
    ...
    try {
      ...
      localStorage.setItem("passwordResetSuccess", "Your password has been changed successfully!")
  ...
  const renderProgressSteps = () => {
    return (
      <div className="flex items-center justify-center mb-8">
        <div className={`flex items-center ${step >= 1 ? "text-[#FF6B2B]" : "text-gray-400"}`}>
          <div
            className={`flex items-center justify-center w-8 h-8 rounded-full border-2 ${step >= 1 ? "border-[#FF6B2B] bg-[#FFF1EB]" : "border-gray-300"}`}
          >
            <MailIcon className="h-4 w-4" />
          </div>
          <span className="ml-2 text-sm font-medium">Email</span>
        </div>
        <div className={`w-12 h-1 mx-2 ${step >= 2 ? "bg-[#FF6B2B]" : "bg-gray-300"}`}></div>
        <div className={`flex items-center ${step >= 2 ? "text-[#FF6B2B]" : "text-gray-400"}`}>
          <div
            className={`flex items-center justify-center w-8 h-8 rounded-full border-2 ${step >= 2 ? "border-[#FF6B2B] bg-[#FFF1EB]" : "border-gray-300"}`}
          >
            <KeyRoundIcon className="h-4 w-4" />
          </div>
          <span className="ml-2 text-sm font-medium">OTP</span>
        </div>
        <div className={`w-12 h-1 mx-2 ${step >= 3 ? "bg-[#FF6B2B]" : "bg-gray-300"}`}></div>
        <div className={`flex items-center ${step >= 3 ? "text-[#FF6B2B]" : "text-gray-400"}`}>
          <div
            className={`flex items-center justify-center w-8 h-8 rounded-full border-2 ${step >= 3 ? "border-[#FF6B2B] bg-[#FFF1EB]" : "border-gray-300"}`}
          >
              ...
              <div>
                ...
                >
                  {isLoading ? (
                    ...
                    <>
                      <span className="absolute left-0 inset-y-0 flex items-center pl-3">
                        <SendIcon className="h-5 w-5 text-[#FF8F5B] group-hover:text-[#FFF1EB]" aria-hidden="true" />
                      </span>
                      Send OTP
                    </>
                  )}
              ...
              <div>
                ...
                >
                  {isLoading ? (
                    ...
                    <>
                      <span className="absolute left-0 inset-y-0 flex items-center pl-3">
                        <LockIcon className="h-5 w-5 text-[#FF8F5B] group-hover:text-[#FFF1EB]" aria-hidden="true" />
                      </span>
                      Reset Password
                    </>
                  )}
