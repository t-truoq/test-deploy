...
export default function ForgetPassword() {
  ...
  const handleSendOtp = async (e) => {
    ...
    try {
      const response = await axios.post(
        `https://09fc-2405-4802-8132-b860-581a-3b2c-b3b4-7b4c.ngrok-free.app/forgotPassword/verifyMail/${email}`,
  ...
  const handleVerifyOtp = async (e) => {
    ...
    try {
      const response = await axios.post(
        `https://09fc-2405-4802-8132-b860-581a-3b2c-b3b4-7b4c.ngrok-free.app/forgotPassword/verifyOtp/${otp}/${email}`,
  ...
  const handleChangePassword = async (e) => {
    ...
    try {
      const response = await axios.post(
        `https://09fc-2405-4802-8132-b860-581a-3b2c-b3b4-7b4c.ngrok-free.app/forgotPassword/changePassword/${email}`,
